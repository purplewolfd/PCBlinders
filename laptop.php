...
<head>
    ...
    <title>Laptops | PCBlinders</title>
...
<body>
    ...
    <!--<div class="container mt-4 d-flex">
      ...
      <div class="card mb-3 w-100">
        <div class="row no-gutters">
          <div class="col-md-4">
            <img src="upload_assets/Pongalpot.png" height="300" width="300" class="card-img" alt="Product Image">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              ...
              <p class="card-text">Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero.</p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="container">
        ...
        <?php
                                ...
                                $query = "SELECT * from products where p_category = 'laptop' order by timestamp_column desc";
