...
<head>
    ...
    <title>PC | Online shopping exclusively for computer geeks.</title>
...
<body>
    ...
    <div class="prebuiltpc-hero py-5 ">
      <h1 class="px-5 display-1 mt-5 py-5 fw-bold text-light" data-aos="fade-right" data-aos-duration="2000" >Choose what you want with <br> high range of <br> Pre-Built PC's</h1>
    </div>
    ...
    <div class="container">
        ...
        <?php
                        ...
                        $query = "SELECT * from products where p_category = 'pc' order by timestamp_column desc";
